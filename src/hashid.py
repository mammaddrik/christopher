...
def hashid(h):
    ...
    if len(mylist) == 0:
        print("└─[\033[1;31mNot Found\033[1;37m]")
    elif len(mylist) > 2:
        mylist.sort()
        print("│\n├─[Possible Hashs")
        print("├────[\033[1;32m"+str(algorithms[mylist[0]])+"\033[1;37m]")
        print("├────["+str(algorithms[mylist[1]])+"]")
        print("│\n├─[Least Possible Hashs")
        for a in range(int(len(mylist))-2):
            print("├────["+str(algorithms[mylist[a+2]])+"]")
        print("└─]")
    else:
        mylist.sort()
        print("│\n├─[Possible Hashs")
        for a in range(len(mylist)):
            print("├────["+str(algorithms[mylist[a]])+"]")
        print("└─]")
    first = None
